...
export const gridItems = [
  {
    id: 1,
    title:
      "We prioritize collaboration with our traders, ensuring open and effective communication throughout your learning journey",
    description: "",
  ...
  {
    id: 2,
    title: "We're flexible with time zones, ensuring you get support whenever needed.",
    description: "",
  ...
  },
  {
    id: 3,
    title: "Our Strategy",
    description: "We continuously enhance our strategies and tools",
    className: "lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
  ...
  {
    id: 4,
    title: "Trading enthusiast with a passion for growth.",
    description: "",
  ...
  {
    id: 5,
    title: "Currently guiding students in developing high-performance trading strategies.",
    description: "The Insider's Edge",
  ...
  {
    id: 6,
    title: "Ready to start trading success together?",
    description: "",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
